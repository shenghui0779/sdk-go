...
func TestRefundByTransactionID(t *testing.T) {
	...
	client.EXPECT().PostXML(RefundApplyURL, WXML{
	...
	r, err := mch.Do(RefundByTransactionID("4008450740201411110005820873", &RefundData{
...
func TestRefundByOutTradeNO(t *testing.T) {
	...
	r, err := mch.Do(RefundByOutTradeNO("1415757673", &RefundData{
		OutRefundNO: "1415701182",
		TotalFee:    1,
		RefundFee:   1,
	}))
...
func TestQueryRefundByRefundID(t *testing.T) {
	...
	client.EXPECT().PostXML(RefundQueryURL, WXML{
		"appid":     "wx2421b1c4370ec43b",
		"mch_id":    "10000100",
		"refund_id": "2008450740201411110000174436",
	...
	r, err := mch.Do(QueryRefundByRefundID("2008450740201411110000174436"))
...
func TestQueryRefundByOutRefundNO(t *testing.T) {
	...
	r, err := mch.Do(QueryRefundByOutRefundNO("1415701182"))
...
func TestQueryRefundByTransactionID(t *testing.T) {
	...
	r, err := mch.Do(QueryRefundByTransactionID("1008450740201411110005820873"))
...
func TestQueryRefundByOutTradeNO(t *testing.T) {
	...
	r, err := mch.Do(QueryRefundByOutTradeNO("1415757673"))
