...
func TestUnifyOrder(t *testing.T) {
	...
	client.EXPECT().PostXML(gomock.AssignableToTypeOf(context.TODO()), "https://api.mch.weixin.qq.com/pay/unifiedorder", public.WXML{
...
func TestQueryOrderByTransactionID(t *testing.T) {
	...
	client.EXPECT().PostXML(gomock.AssignableToTypeOf(context.TODO()), "https://api.mch.weixin.qq.com/pay/orderquery", public.WXML{
		"appid":          "wx2421b1c4370ec43b",
		"mch_id":         "10000100",
...
func TestCloseOrder(t *testing.T) {
	...
	client.EXPECT().PostXML(gomock.AssignableToTypeOf(context.TODO()), "https://api.mch.weixin.qq.com/pay/closeorder", public.WXML{
		"appid":        "wx2421b1c4370ec43b",
		"mch_id":       "10000100",
