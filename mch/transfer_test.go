...
func TestTransferToBalance(t *testing.T) {
	...
	client.EXPECT().PostXML(TransferToBalanceURL, WXML{
	...
	r, err := mch.Do(TransferToBalance(&TransferBalanceData{
...
func TestQueryTransferBalanceOrder(t *testing.T) {
	...
	client.EXPECT().PostXML(TransferBalanceOrderQueryURL, WXML{
	...
	r, err := mch.Do(QueryTransferBalanceOrder("1000005901201407261446939628"))
...
// 	client.EXPECT().PostXML(TransferToBankCardURL, WXML{
// 		"mch_id":           "10000100",
...
// 	r, err := mch.Do(TransferToBankCard(&TransferBankCardData{
...
func TestQueryTransferBankCardOrder(t *testing.T) {
	...
	client.EXPECT().PostXML(TransferBankCardOrderQueryURL, WXML{
		"mch_id":           "10000100",
		"partner_trade_no": "1212121221278",
		"nonce_str":        "50780e0cca98c8c8e814883e5caa672e",
	...
	r, err := mch.Do(QueryTransferBankCardOrder("1212121221278"))
