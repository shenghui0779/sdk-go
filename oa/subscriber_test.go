...
func TestGetSubscriberInfo(t *testing.T) {
	...
	client.EXPECT().Get(gomock.AssignableToTypeOf(context.TODO()), "https://api.weixin.qq.com/cgi-bin/user/info?access_token=ACCESS_TOKEN&openid=OPENID&lang=zh_CN").Return([]byte(`{
		"subscribe": 1,
	...
	assert.Equal(t, &SubscriberInfo{
		...
		Province:       "广东",
		Country:        "中国",
		AvatarURL:      "http://thirdwx.qlogo.cn/mmopen/g3MonUZtNHkdmzicIlibx6iaFqAc56vxLSUfpb6n5WKSYVY0ChQKkiaJSgQ1dZuTOgvLLrhJbERQQ4eMsv84eavHiaiceqxibJxCfHe/0",
	...
	assert.Equal(t, []SubscriberInfo{
		{
			...
			Province:       "广东",
			Country:        "中国",
			AvatarURL:      "http://thirdwx.qlogo.cn/mmopen/xbIQx1GRqdvyqkMMhEaGOX802l1CyqMJNgUzKP8MeAeHFicRDSnZH7FY4XB7p8XHXIf6uJA2SCunTPicGKezDC4saKISzRj3nz/0",
